...
// TODO: Rework full the authChecker to support multiple guards and more complex scenarios
// https://typegraphql.com/docs/authentication.html#custom-authchecker
// https://docs.adonisjs.com/guides/auth/introduction
// https://docs.adonisjs.com/guides/bouncer/introduction
export const authChecker: AuthChecker<HttpContext, BouncerAbility<any>> = async ({ context }, abilities) => {
    if (!('auth' in context)) {
